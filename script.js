...
function setupMusicPlayer() {
  const setMusicLabel = () => {
    musicState.textContent = music.paused ? "Music: Off" : "Music: On";
  };
  ...
  music.addEventListener("pause", setMusicLabel);
  music.addEventListener("play", setMusicLabel);
  setMusicLabel();
}
...
function setupThemeMode() {
  ...
  if (savedTheme === "dark") {
    ...
    themeState.textContent = "Light Mode";
  } else {
    themeState.textContent = "Dark Mode";
  }

  themeToggle.addEventListener("click", () => {
    const isDark = document.body.classList.toggle("dark-mode");
    themeState.textContent = isDark ? "Light Mode" : "Dark Mode";
